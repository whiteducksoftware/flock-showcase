...
# --------------------------------
# Virtual Pet State (Global for this example)
# --------------------------------
# In a real application, you might use a database or file storage
PET = {
    "name": "Pixel",
    "type": "digital cat",
    "hunger": 50,  # 0-100 (0: starving, 100: full)
    "happiness": 50,  # 0-100 (0: sad, 100: very happy)
    "energy": 50,  # 0-100 (0: exhausted, 100: energetic)
...
def feed_pet(food_item: str) -> str:
    ...
    food_effects = {
        "basic kibble": {"hunger": 15, "happiness": 5},
        "premium kibble": {"hunger": 25, "happiness": 10},
        "gourmet fish": {"hunger": 40, "happiness": 20},
        "treat": {"hunger": 5, "happiness": 15},
    }

    # Default effect for unknown foods
    effect = food_effects.get(food_item, {"hunger": 10, "happiness": 5})
