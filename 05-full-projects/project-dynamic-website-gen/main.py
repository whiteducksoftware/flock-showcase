...
class DynamicHTMLApp(BaseModel):
    ...
    requirements: list[str] = Field(
        ..., description="User specified requirements for the app"
    )
    description: str = Field(
        ...,
        description="High level description of the data and functionality of the app, as well as design decisions",
    )
...
result = flock.run(
    agent=app_agent, input={"requirements": requirements, "input_data": input_data}
)
app = result.app
